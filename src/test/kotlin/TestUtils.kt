...
fun createNewGitProject(): GitProject {
    ...
    getCommandOutput(listOf("git", "config", "--add", "user.name", "Origin Maintainer"), originDir)
    getCommandOutput(listOf("git", "config", "--add", "user.email", "origin@example.com"), originDir)
    ...
    getCommandOutput(listOf("git", "config", "--add", "user.name", "Test User"), localDir)
    getCommandOutput(listOf("git", "config", "--add", "user.email", "test@example.com"), localDir)
